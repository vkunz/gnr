...
GNRMathMatrix4x4::GNRMathMatrix4x4(float e0, float e1, float e2, float e3,
...
GNRMathMatrix4x4::GNRMathMatrix4x4(const GNRMathMatrix4x4 & rhs)
{
	memcpy(entries, rhs.entries, 16*sizeof(float));
}

GNRMathMatrix4x4::GNRMathMatrix4x4(const float * rhs)
{
	memcpy(entries, rhs, 16*sizeof(float));
}

void GNRMathMatrix4x4::SetEntry(int position, float value)
{
	if (position>=0 && position<=15)
		entries[position]=value;
}

float GNRMathMatrix4x4::GetEntry(int position) const
{
	if (position>=0 && position<=15)
...
VECTOR4D GNRMathMatrix4x4::GetRow(int position) const
{
	if (position==0)
...
VECTOR4D GNRMathMatrix4x4::GetColumn(int position) const
{
	if (position==0)
...
void GNRMathMatrix4x4::LoadIdentity(void)
{
...
void GNRMathMatrix4x4::LoadZero(void)
{
	memset(entries, 0, 16*sizeof(float));
}

GNRMathMatrix4x4 GNRMathMatrix4x4::operator+(const GNRMathMatrix4x4 & rhs) const		//overloaded operators
{
	return GNRMathMatrix4x4(entries[0]+rhs.entries[0],
...
GNRMathMatrix4x4 GNRMathMatrix4x4::operator*(const GNRMathMatrix4x4 & rhs) const
{
	...
	{
		return GNRMathMatrix4x4(entries[0]*rhs.entries[0]+entries[4]*rhs.entries[1]+entries[8]*rhs.entries[2],
	...
	if (entries[3]==0.0f && entries[7]==0.0f && entries[11]==0.0f && entries[15]==1.0f)
	{
		return GNRMathMatrix4x4(entries[0]*rhs.entries[0]+entries[4]*rhs.entries[1]+entries[8]*rhs.entries[2]+entries[12]*rhs.entries[3],
...
GNRMathMatrix4x4 GNRMathMatrix4x4::operator*(const float rhs) const
{
	return GNRMathMatrix4x4(entries[0]*rhs,
	                        entries[1]*rhs,
	                        entries[2]*rhs,
	                        entries[3]*rhs,
	                        entries[4]*rhs,
...
GNRMathMatrix4x4 operator*(float scaleFactor, const GNRMathMatrix4x4 & rhs)
{
	return rhs*scaleFactor;
}

bool GNRMathMatrix4x4::operator==(const GNRMathMatrix4x4 & rhs) const
{
	for (int i=0; i<16; i++)
	{
...
void GNRMathMatrix4x4::operator+=(const GNRMathMatrix4x4 & rhs)
{
	(*this)=(*this)+rhs;
}
...
void GNRMathMatrix4x4::operator*=(const float rhs)
{
	(*this)=(*this)*rhs;
}
...
GNRMathMatrix4x4 GNRMathMatrix4x4::operator-(void) const
{
	GNRMathMatrix4x4 result(*this);
...
VECTOR4D GNRMathMatrix4x4::operator*(const VECTOR4D rhs) const
{
...
VECTOR3D GNRMathMatrix4x4::GetRotatedVector3D(const VECTOR3D & rhs) const
{
...
VECTOR3D GNRMathMatrix4x4::GetInverseRotatedVector3D(const VECTOR3D & rhs) const
{
	//rotate by transpose:
...
VECTOR3D GNRMathMatrix4x4::GetTranslatedVector3D(const VECTOR3D & rhs) const
{
	return VECTOR3D(rhs.x+entries[12], rhs.y+entries[13], rhs.z+entries[14]);
}

VECTOR3D GNRMathMatrix4x4::GetInverseTranslatedVector3D(const VECTOR3D & rhs) const
{
	return VECTOR3D(rhs.x-entries[12], rhs.y-entries[13], rhs.z-entries[14]);
}

void GNRMathMatrix4x4::Invert(void)
{
	*this=GetInverse();
}

GNRMathMatrix4x4 GNRMathMatrix4x4::GetInverse(void) const
{
	GNRMathMatrix4x4 result=GetInverseTranspose();
...
void GNRMathMatrix4x4::Transpose(void)
{
	*this=GetTranspose();
}

GNRMathMatrix4x4 GNRMathMatrix4x4::GetTranspose(void) const
{
	return GNRMathMatrix4x4(entries[ 0], entries[ 4], entries[ 8], entries[12],
...
void GNRMathMatrix4x4::InvertTranspose(void)
{
	*this=GetInverseTranspose();
}

GNRMathMatrix4x4 GNRMathMatrix4x4::GetInverseTranspose(void) const
{
	GNRMathMatrix4x4 result;
...
void GNRMathMatrix4x4::AffineInvert(void)
{
	(*this)=GetAffineInverse();
}

GNRMathMatrix4x4 GNRMathMatrix4x4::GetAffineInverse(void) const
{
	//return the transpose of the rotation part
	//and the negative of the inverse rotated translation part
	return GNRMathMatrix4x4(entries[0],
	                        entries[4],
	                        entries[8],
	                        0.0f,
	                        entries[1],
...
void GNRMathMatrix4x4::AffineInvertTranspose(void)
{
	(*this)=GetAffineInverseTranspose();
}

GNRMathMatrix4x4 GNRMathMatrix4x4::GetAffineInverseTranspose(void) const
{
	//return the transpose of the rotation part
	//and the negative of the inverse rotated translation part
	//transposed
...
void GNRMathMatrix4x4::SetTranslation(const VECTOR3D & translation)
{
	LoadIdentity();
...
void GNRMathMatrix4x4::SetScale(const VECTOR3D & scaleFactor)
{
	LoadIdentity();
...
void GNRMathMatrix4x4::SetUniformScale(const float scaleFactor)
{
	LoadIdentity();
...
void GNRMathMatrix4x4::SetRotationAxis(const double angle, const VECTOR3D & axis)
{
...
void GNRMathMatrix4x4::SetRotationX(const double angle)
{
	LoadIdentity();
...
void GNRMathMatrix4x4::SetRotationY(const double angle)
{
	LoadIdentity();
...
void GNRMathMatrix4x4::SetRotationZ(const double angle)
{
	LoadIdentity();
...
void GNRMathMatrix4x4::SetRotationEuler(const double angleX, const double angleY, const double angleZ)
{
	LoadIdentity();
...
void GNRMathMatrix4x4::SetPerspective(float left, float right, float bottom,
...
void GNRMathMatrix4x4::SetPerspective(float fovy, float aspect, float n, float f)
{
...
void GNRMathMatrix4x4::SetOrtho(float left, float right, float bottom,
                                float top, float n, float f)
{
	LoadIdentity();
...
void GNRMathMatrix4x4::SetTranslationPart(const VECTOR3D & translation)
{
...
void GNRMathMatrix4x4::SetRotationPartEuler(const double angleX, const double angleY, const double angleZ)
{
