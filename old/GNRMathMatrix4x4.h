#ifndef GNRMathMatrix4x4_H
#define GNRMathMatrix4x4_H

class GNRMathMatrix4x4
{
public:
	GNRMathMatrix4x4()
	{
	...
	GNRMathMatrix4x4(float e0, float e1, float e2, float e3,
	                 float e4, float e5, float e6, float e7,
	                 float e8, float e9, float e10, float e11,
	                 float e12, float e13, float e14, float e15);
	GNRMathMatrix4x4(const float * rhs);
	GNRMathMatrix4x4(const GNRMathMatrix4x4 & rhs);
	~GNRMathMatrix4x4() {}	//empty
	...
	//binary operators
	GNRMathMatrix4x4 operator+(const GNRMathMatrix4x4 & rhs) const;
	GNRMathMatrix4x4 operator-(const GNRMathMatrix4x4 & rhs) const;
	GNRMathMatrix4x4 operator*(const GNRMathMatrix4x4 & rhs) const;
	GNRMathMatrix4x4 operator*(const float rhs) const;
	GNRMathMatrix4x4 operator/(const float rhs) const;
	friend GNRMathMatrix4x4 operator*(float scaleFactor, const GNRMathMatrix4x4 & rhs);
	
	bool operator==(const GNRMathMatrix4x4 & rhs) const;
	bool operator!=(const GNRMathMatrix4x4 & rhs) const;
	
	//self-add etc
	void operator+=(const GNRMathMatrix4x4 & rhs);
	void operator-=(const GNRMathMatrix4x4 & rhs);
	void operator*=(const GNRMathMatrix4x4 & rhs);
	...
	//unary operators
	GNRMathMatrix4x4 operator-(void) const;
	GNRMathMatrix4x4 operator+(void) const
	{
		return (*this);
	}
	...
	//Other methods
	void Invert(void);
	GNRMathMatrix4x4 GetInverse(void) const;
	void Transpose(void);
	GNRMathMatrix4x4 GetTranspose(void) const;
	void InvertTranspose(void);
	GNRMathMatrix4x4 GetInverseTranspose(void) const;
	
	//Inverse of a rotation/translation only matrix
	void AffineInvert(void);
	GNRMathMatrix4x4 GetAffineInverse(void) const;
	void AffineInvertTranspose(void);
	GNRMathMatrix4x4 GetAffineInverseTranspose(void) const;
