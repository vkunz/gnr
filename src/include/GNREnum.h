...
enum eventType  { GLREFRESH = 0, NEWROOM, OPXOPEN, OPXSAVE, OAXIMPORT, OAXEXPORT, OBJIMPORT, OBJEXPORT, TOOLBARCHANGE,
                  ...
                  CUTSELECTED, HIDESELECTED, CANCELCONVERTION, TOGGLESHADOWS, REFRESHSCENETREE, EMPTYTRASH
                };

enum treeEventType { LIBRARYDELETE, LIBRARYPASTE, LIBRARYEXPORT, LIBRARYNEWCAT, LIBRARYRENAME, SCENEVISIBLE, SCENEHIDE,
