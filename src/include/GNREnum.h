...
enum eventType  { GLREFRESH = 0, NEWROOM, OPXOPEN, OPXSAVE, OAXIMPORT, OAXEXPORT, OBJIMPORT, OBJEXPORT, TOOLBARCHANGE,
                  ...
                  CREATECUBOID, CREATESPHERE, CREATECONE, CREATECYLINDER, CREATEPYRAMIDE
                };

enum treeEventType { LIBRARYDELETE, LIBRARYPASTE, LIBRARYEXPORT, LIBRARYNEWCAT, LIBRARYRENAME, LIBRARYMENURENAME,
                     SCENEVISIBLE, SCENEHIDE, SCENESELECT, SCENEDESELECT, SCENEDELETE, SCENEUNDELETE
                   };
